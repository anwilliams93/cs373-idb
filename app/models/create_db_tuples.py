from db_data import retrieve_funruns, retrieve_themes, retrieve_challenges, retrieve_locations
# Creates a file called database_commands.txt to copy into create_database.py with commands to populate
# all of the data we have stored in db_data.py
