...
class TestChallengeFilter (TestCase) :
	...
	def test_challenge_filter_run4 (self) :
		self.maxDiff = None
		url = server_address + '/api/challenges?theme=2'
		response = urllib.request.urlopen(url)
		response_object = http_response_to_json_object(response)
		expected = json.loads(json.dumps( {
			"challenges": [
	...
	def test_challenge_filter_run5 (self) :
	...
	def test_challenge_filter_run6 (self) :
	...
	def test_challenge_filter_run7 (self) :
	...
	def test_challenge_filter_run8 (self) :
		url = server_address + '/api/challenges?min_difficulty=90'
		response = urllib.request.urlopen(url)
		response_object = http_response_to_json_object(response)
		expected = json.loads(json.dumps( {
			"challenges": []
	...
	def test_challenge_filter_run9 (self) :
		url = server_address + '/api/challenges?max_difficulty=10'
		response = urllib.request.urlopen(url)
		response_object = http_response_to_json_object(response)
		expected = json.loads(json.dumps( {
			"challenges": [
	...
	def test_challenge_filter_run10 (self) :
		url = server_address + '/api/challenges?min_difficulty=50'
		response = urllib.request.urlopen(url)
		response_object = http_response_to_json_object(response)
		expected = json.loads(json.dumps( {
	...
	def test_challenge_filter_run11 (self) :
		url = server_address + '/api/challenges?funrun=11'
		response = urllib.request.urlopen(url)
		response_object = http_response_to_json_object(response)
		expected = json.loads(json.dumps( {
			"challenges": [
	...
	def test_challenge_filter_run12 (self) :
		url = server_address + '/api/challenges?funrun=12'
		response = urllib.request.urlopen(url)
		response_object = http_response_to_json_object(response)
		expected = json.loads(json.dumps( {
			"challenges": [
	...
	def test_challenge_filter_run13 (self) :
		url = server_address + '/api/challenges?theme=12'
		response = urllib.request.urlopen(url)
		response_object = http_response_to_json_object(response)
		expected = json.loads(json.dumps( {
			"challenges": [
	...
	def test_challenge_filter_run14 (self) :
		url = server_address + '/api/challenges?theme=7'
		response = urllib.request.urlopen(url)
		response_object = http_response_to_json_object(response)
		expected = json.loads(json.dumps( {
			"challenges": [
	...
	def test_challenge_filter_run15 (self) :
		url = server_address + '/api/challenges?funrun=7'
		response = urllib.request.urlopen(url)
		response_object = http_response_to_json_object(response)
		expected = json.loads(json.dumps( {
			"challenges": [
	...
	def test_challenge_filter_run16 (self) :
		url = server_address + '/api/challenges?funrun=17'
		response = urllib.request.urlopen(url)
		response_object = http_response_to_json_object(response)
		expected = json.loads(json.dumps( {
			"challenges": [
	...
	def test_challenge_filter_run17 (self) :
		url = server_address + '/api/challenges?funrun=9'
		response = urllib.request.urlopen(url)
		response_object = http_response_to_json_object(response)
		expected = json.loads(json.dumps( {
			"challenges": [
	...
	def test_challenge_filter_run18 (self) :
		url = server_address + '/api/challenges?theme=9'
		response = urllib.request.urlopen(url)
		response_object = http_response_to_json_object(response)
		expected = json.loads(json.dumps( {
			"challenges": [
