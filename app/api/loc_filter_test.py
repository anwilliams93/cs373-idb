...
class TestChallengesSort (TestCase) :
  ...
  # Test outside conditions where max_temp = 0 and min_temp = 100
  def test_filter_1 (self) :
    url = server_address + '/api/locations?min_winter_temp=100'
  ...
  def test_filter_2 (self) :
    url = server_address + '/api/locations?max_winter_temp=0'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [] }))
  ...
  def test_filter_3 (self) :
    url = server_address + '/api/locations?min_spring_temp=100'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [] }))
  ...
  def test_filter_4 (self) :
    url = server_address + '/api/locations?max_spring_temp=0'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [] }))
  ...
  def test_filter_5 (self) :
    url = server_address + '/api/locations?min_fall_temp=100'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [] }))
  ...
  def test_filter_6 (self) :
    url = server_address + '/api/locations?max_fall_temp=0'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [] }))
  ...
  def test_filter_7 (self) :
    url = server_address + '/api/locations?min_summer_temp=100'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [] }))
  ...
  def test_filter_8 (self) :
    url = server_address + '/api/locations?max_summer_temp=0'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [] }))
  ...
  def test_filter_9 (self) :
    url = server_address + '/api/locations?funrun=0'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  def test_filter_10 (self) :
    url = server_address + '/api/locations?funrun=1'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  def test_filter_11 (self) :
    url = server_address + '/api/locations?funrun=2'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  def test_filter_12 (self) :
    url = server_address + '/api/locations?funrun=3'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  def test_filter_13 (self) :
    url = server_address + '/api/locations?funrun=4'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  def test_filter_14 (self) :
    url = server_address + '/api/locations?funrun=5'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  def test_filter_15 (self) :
    url = server_address + '/api/locations?funrun=6'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  def test_filter_16 (self) :
    url = server_address + '/api/locations?funrun=7'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  def test_filter_17 (self) :
    url = server_address + '/api/locations?funrun=8'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  def test_filter_18 (self) :
    url = server_address + '/api/locations?funrun=9'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  def test_filter_18 (self) :
    url = server_address + '/api/locations?funrun=10'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
...
# test more temperature conditions
  def test_filter_19 (self) :
    url = server_address + '/api/locations?min_winter_temp=60'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [] }))
  ...
  def test_filter_20 (self) :
    url = server_address + '/api/locations?max_winter_temp=60'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  def test_filter_21 (self) :
    url = server_address + '/api/locations?min_spring_temp=50'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  def test_filter_22 (self) :
    url = server_address + '/api/locations?max_spring_temp=50'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  def test_filter_23 (self) :
    url = server_address + '/api/locations?max_summer_temp=60'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [] }))
  ...
  def test_filter_24 (self) :
    url = server_address + '/api/locations?max_spring_temp=40'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  # Test outside conditions where max_temp = 0 and min_temp = 100
  def test_filter_26 (self) :
    url = server_address + '/api/locations?max_summer_temp=40'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [] }))
  ...
  # Test outside conditions where max_temp = 0 and min_temp = 100
  def test_filter_27 (self) :
    url = server_address + '/api/locations?max_spring_temp=70'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  # Test outside conditions where max_temp = 0 and min_temp = 100
  def test_filter_28 (self) :
    url = server_address + '/api/locations?min_winter_temp=80'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [] }))
  ...
  # Test outside conditions where max_temp = 0 and min_temp = 100
  def test_filter_29 (self) :
    url = server_address + '/api/locations?max_fall_temp=50'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
  ...
  # Test outside conditions where max_temp = 0 and min_temp = 100
  def test_filter_30 (self) :
    url = server_address + '/api/locations?min_fall_temp=50'
    response = urllib.request.urlopen(url)
    response_object = http_response_to_json_object(response)
    expected = json.loads(json.dumps({
  "locations": [
