...
def retrieve_themes():
	themes = [
			    ...
			    },
			    {
			        ...
			        'description':  u'Whether it is an excuse to travel and exercise, or a good distraction from the aches and pains of running, the location of a race is a great factor in deciding which run works for you! Explore famous landmarks as you race to glory!',
			    ...
			    },
			    {
			        ...
			        'short':		u'Hold yourself together while being part of these runs.',
